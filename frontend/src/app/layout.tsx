...
import "./globals.css";
import { Home, Briefcase, TrendingUp, Compass, Activity } from "lucide-react";
          ...
          <div className="max-w-6xl mx-auto px-4 h-14 flex items-center justify-between">
            ...
            <div className="flex items-center space-x-3 flex-1">
              ...
              <div className="max-w-md w-full hidden sm:block relative">
                ...
                />
                <svg
                  className="absolute left-3 top-2.5 h-4 w-4 text-[#5e5e5e]"
                  fill="none"
                  viewBox="0 0 24 24"
                  stroke="currentColor"
                >
            ...
            <nav className="flex items-center space-x-1 sm:space-x-4">
              <Link
                href="/"
                className="flex flex-col items-center justify-center px-3 text-[#5e5e5e] hover:text-[#191919] group border-b-2 border-transparent hover:border-[#191919] h-14 transition-all"
              >
